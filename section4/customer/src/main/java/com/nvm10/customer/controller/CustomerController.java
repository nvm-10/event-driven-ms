package com.nvm10.customer.controller;
...
public class CustomerController {
    ...
    @PatchExchange("/mobile-number")
    public ResponseEntity<ResponseDto> updateMobileNumber(@Valid @RequestBody MobileNumberUpdateDto mobileNumberUpdateDto) {

        boolean isMobileNumberUpdated = iCustomerService.updateMobileNumber(mobileNumberUpdateDto);
        return ResponseEntity.status(HttpStatus.OK).body(
                new ResponseDto(CustomerConstants.STATUS_200, CustomerConstants.MESSAGE_200)
        );
    }
